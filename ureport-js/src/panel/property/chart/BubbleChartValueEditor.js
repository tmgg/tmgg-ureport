...
export default class ScatterChartValueEditor extends CategoryChartValueEditor{
    constructor(parentContainer,context){
        ...
        const dsLI=$(`<li class="active"><a href="#chart_bind_dataset_bubble" data-toggle="tab">数据集绑定</a></li>`);
        tabUL.append(dsLI);
        const optionLI=$(`<li><a href="#chart_option_bubble" data-toggle="tab">选项</a></li>`);
        tabUL.append(optionLI);
        this.axisLI=$(`<li><a href="#chart_axis_bubble" data-toggle="tab">轴配置</a></li>`);
    ...
    _initDatasetTab(dsContent){
        ...
        const rPropertyGroup=$(`<div class="form-group" style="margin-bottom: 5px;"><label>半径值属性：</label></div>`);
