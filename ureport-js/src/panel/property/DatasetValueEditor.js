...
export default class DatasetValueEditor extends BaseValueEditor{
    ...
    _init(){
        ...
        this.descSortRadio=$(`<label class="checkbox-inline" style="padding-left: 2px"><input type="radio" name="__sort_radio" value="desc">倒序</label>`);
    ...
    _buildMappingTable(container){
        ...
        const addButton=$(`<button type="button" class="btn btn-default" style="float: right;" title="addMappping"><i class="glyphicon glyphicon-plus-sign" style="color: #00746f;"></i></button>`);
