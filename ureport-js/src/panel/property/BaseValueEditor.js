...
export default class BaseValueEditor{
    ...
    _buildFormat(container){
        ...
        this.formatEditor=$(`<input type="text" class="form-control" style="display: inline-block;width: 302px;padding: 3px;font-size: 12px;height: 25px;" placeholder="对日期或数字格式化，如#.##">`);
