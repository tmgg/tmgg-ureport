...
public class ColumnParser implements Parser<ColumnDefinition> {
	...
	public void convert(Object data, Element el) {
		ColumnDefinition col= (ColumnDefinition) data;
		ParserTool<ColumnDefinition> tool = new ParserTool<>(el, col, new ColumnDefinition());
		tool.attr("col-number", ColumnDefinition::getColumnNumber);
		tool.attr("hide", ColumnDefinition::isHide);
		tool.attr("width", ColumnDefinition::getWidth);
	}
}
