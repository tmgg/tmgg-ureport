...
public class HeaderFooterParser implements Parser<HeaderFooterDefinition> {
	...
	public void convert(Object data, Element el) {
		HeaderFooterDefinition hf= (HeaderFooterDefinition) data;

		ParserTool<HeaderFooterDefinition> tool = new ParserTool<>(el, hf, new HeaderFooterDefinition());

		tool.attr("margin", HeaderFooterDefinition::getMargin);
		tool.attr("bold", HeaderFooterDefinition::isBold);
		tool.attr("italic", HeaderFooterDefinition::isItalic);
		tool.attr("underline", HeaderFooterDefinition::isUnderline);
		tool.attr("font-family", HeaderFooterDefinition::getFontFamily);
		tool.attr("forecolor", HeaderFooterDefinition::getForecolor);
		tool.attr("font-size", HeaderFooterDefinition::getFontSize);
		tool.childText("left",HeaderFooterDefinition::getLeft);
		tool.childText("center",HeaderFooterDefinition::getCenter);
		tool.childText("right",HeaderFooterDefinition::getRight);
	}
}
