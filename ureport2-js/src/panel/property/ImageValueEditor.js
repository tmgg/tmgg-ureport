...
export default class ImageValueEditor extends BaseValueEditor{
    ...
    _initPathEditor(){
        ...
        this.pathEditor=$(`<input class="form-control" title="默认支持以classpath:开头位于classpath下的图片文件，或以/开头位于WEB应用根下或某目录下的图片文件" placeholder="默认支持以classpath:开头位于classpath下的图片文件，或以/开头位于WEB应用根下或某目录下的图片文件" style="display: inline-block;width: 325px;padding: 5px">`);
