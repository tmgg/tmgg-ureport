...
export default class PDFPrintDialog{
    ...
    initBody(){
        ...
        <legend style="font-size: 12px;width: 60px;border-bottom: none;margin-bottom: 0;">打印配置</legend>
        </fieldset>`);
        ...
        const pageWidthGroup=$(`<div class="form-group" style="display: inline-block;margin-left: 6px"><span>宽(毫米):</span></div>`);
        ...
        const pageHeightGroup=$(`<div class="form-group" style="display: inline-block;margin-left: 6px"><span>高(毫米):</span></div>`);
        ...
        const orientationGroup=$(`<div class="form-group" style="display: inline-block;margin-left: 6px"><label>方向:</label></div>`);
        ...
        const leftMarginGroup=$(`<div class="form-group" style="display: inline-block;margin-left:6px"><label>左边距(毫米):</label></div>`);
        ...
        const rightMarginGroup=$(`<div class="form-group" style="display: inline-block;margin-top: 5px;margin-left: 6px""><label>右边距(毫米):</label></div>`);
        ...
        const topMarginGroup=$(`<div class="form-group" style="display: inline-block;margin-left: 6px;"><label>上边距(毫米):</label></div>`);
        ...
        const bottomMarginGroup=$(`<div class="form-group" style="display: inline-block;margin-left: 6px""><label>下边距(毫米):</label></div>`);
